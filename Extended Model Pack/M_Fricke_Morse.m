function [Y, Jacobian] = M_Fricke_Morse(f, par, model_options )
% Series R-CPE circuit with resistive leakage also known as Fricke and Morse circuit used for tissues and cells suspensions, 
% electrochemical systems with Faradic currents, 
% systems with resistive parasitic leakage
